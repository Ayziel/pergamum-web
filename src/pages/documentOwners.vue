...
const documentOwners = reactive<DocumentOwners[]>([
  ...
  { name: 'Ava Moore', role: 'Admin', email: 'ava.moore@example.com', selected: false }, // ADD: Random date
  { name: 'Lucas Green', role: 'IT', email: 'lucas.green@example.com', selected: false }, // ADD: Random date
